		...
		<div class="container" style="margin-top:10%">
                    ...
                    <table class="table table-striped" >
                        ...
                        @foreach ($return_data['engs'] as $eng)
                            <tr>
                                <td scope="row">{{$eng['id']}}</td>
                                <td scope="row">{{$eng['name']}}</td>
                                <td scope="row">{{DB::table('cars')->where('id', $eng['cars_id'])->first()->name}}</td>
                                <td scope="row">{{$eng['kw_hp']}}</td>
                                <td scope="row">{{$eng['ccm']}}</td>
                                <td scope="row">{{$eng['cylinders']}}</td>
                                <td scope="row">{{$eng['valves']}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
