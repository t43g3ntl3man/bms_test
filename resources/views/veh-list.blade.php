			...
			<div class="container" style="margin-top:10%">
                    ...
                    <table class="table table-striped" >
                        <thead>
                            ...
                            <th scope="col">KW / HP</th>
                            <th scope="col">CCM</th>
                            <th scope="col">Cylinders</th>
                            <th scope="col">Valves</th>
                            <th scope="col">Gas</th>
                            <th scope="col">years_active</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach ($return_data['vehs'] as $veh)
                            <tr>
                                <td scope="row">{{$veh['id']}}</td>
                                <td scope="row">{{$veh['name']}}</td>
                                <td scope="row">{{DB::table('vehicle_brand_models')->where('id', $veh['vehicle_brand_models_id'])->first()->name}}</td>
                                <td scope="row">{{$veh['kw_hp']}}</td>
                                <td scope="row">{{$veh['ccm']}}</td>
                                <td scope="row">{{$veh['cylinders']}}</td>
                                <td scope="row">{{$veh['valves']}}</td>
                                <td scope="row">{{$veh['gas']}}</td>
                                <td scope="row">{{$veh['years_active']}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
