    ...
    <body>
        ...
        <div id="snippet--hierarchy">
            ...
            <section role="region" id="snippet--customerForm">
                <div class="container">
                    <div class="site-form site-form--register">
                        <h1 class="text-center">Checkout Detail</h1>
                    </div>
                </div>
            </section>
            @if($errors->any())
            ...
            <div id="snippet-customerPersonFormRegister-">
                <form action="/checkout" method="post" id="frm-customerPersonFormRegister-customerRegisterForm" novalidate="" style="width: 75%">
                    {{ csrf_field() }}
                    <h2 class="site-form__section-heading"></h2>
                    <div class="site-form__section-content">
                        <div class="site-form__line site-form__line--pack">
                            <label class="col-form-label" for="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail">Set AddressLine 1&nbsp;<span class="text-danger">*</span></label>
                            <input type="text" name="setAddressLine1" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        <div class="site-form__line site-form__line--pack">
                            <label class="col-form-label" for="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail">Set AddressLine 2&nbsp;<span class="text-danger">*</span></label>
                            <input type="text" name="setAddressLine2" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        <div class="site-form__line site-form__line--pack">
                            <label class="col-form-label" for="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail">Set AddressLine 3&nbsp;<span class="text-danger">*</span></label>
                            <input type="text" name="setAddressLine3" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        <div class="site-form__line site-form__line--pack">
                            <label class="col-form-label" for="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail">Set PostalCode&nbsp;<span class="text-danger">*</span></label>
                            <input type="text" name="setPostalCode" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        <input type="hidden" name="cco" maxlength="80" autocomplete="email" id="cco" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                        <div class="site-form__line site-form__line--pack">
                            <label class="col-form-label" for="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail">Set FirstName&nbsp;<span class="text-danger">*</span></label>
                            <input type="text" name="setFirstName" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        <div class="site-form__line site-form__line--pack">
                            <label class="col-form-label" for="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail">Set LastName&nbsp;<span class="text-danger">*</span></label>
                            <input type="text" name="setLastName" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        <div class="site-form__line site-form__line--pack">
                            ...
                            <input type="email" name="setBuyerEmailAddress" maxlength="80" autocomplete="email" id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail" class="form-control" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message">
                            <div id="frm-customerPersonFormRegister-customerRegisterForm-userSignUp-userEmail_message"></div>
                        </div>
                        ...
                        <div class="site-form__section-content" id="unconnected">
                            <div class="site-form__line site-form__line--pack js-focused">
                                <input id="card-button" name="login" class="btn btn-primary w100" value="Attach Card" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-register_message">
                                <div id="frm-customerPersonFormRegister-customerRegisterForm-register_message"></div>
                            </div>
                        </div>
                        <div class="site-form__section-content" id="connected" style="display: none">
                            <div class="site-form__line site-form__line--pack js-focused">
                                <input type="submit" name="login" class="btn btn-primary w100" value="Pay" data-lfv-initialized="true" data-lfv-message-id="frm-customerPersonFormRegister-customerRegisterForm-register_message">
                                <div id="frm-customerPersonFormRegister-customerRegisterForm-register_message"></div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="module">
            const payments = Square.payments('sandbox-sq0idb-5r48Hk6BhsSrgEUnMsvrDA', 'TC4Z3ZEBKRXRH');
            ...
            cardButton.addEventListener('click', async () => {
                ...
                try {
                    ...
                    document.getElementById('cco').value = result.token
