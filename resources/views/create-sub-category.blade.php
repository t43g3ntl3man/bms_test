                ...
                <div class="container">
                    <div class="site-form site-form--register">
                        ...
                        <div id="snippet-customerPersonFormRegister-">
                            <form action="create_sub_category_post" method="post" id="frm-customerPersonFormRegister-customerRegisterForm" novalidate="">
								{{ csrf_field() }}
                                ...
                                <h2 class="site-form__section-heading">Category</h2>
                                <div class="site-form__section-content">
                                    <div class="site-form__line site-form__line--pack">
                                        ...
                                        <select name="category" class="js-select select2-hidden-accessible"  required=""  tabindex="1" aria-hidden="false">
